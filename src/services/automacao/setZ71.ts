...
import { buscaProxLoteZ71, buscaRecnoZ71, buscaSEQZ71, checkExistOS, executeQueryLocal, existWMSBag, getBag, getEnderDisp, getEndereco, getMaxItemOS, getMaxMovEnderID, getTag, insWMSBag, setStatusOPSeq, setWMSItemOS, setWMSOS, updWMSBag } from "../../utils/dbExecute";
...
export async function setZ71(dados: Z71DTO): Promise<Retorno> {
        try {
            ...
            await executeQueryLocal(sqlInsMovEnder, params);
            ...
            if(tipoSql === "INS") {
                ...
                if (dados.nQtdIns != null) {
                    if(dados.nQtdIns > 0) {
                        ...
                        for(let i = 0; i < dados.nQtdIns; i++) {
                            ...
                            await executeQueryLocal(sql, insertParams);
                ...
                await executeQueryLocal(sql, updateParams);
            ...
            if (!errorMessage.includes("conversion") || errorMessage.includes("converting")) {
                apiError = "executeQueryLocal - Erro de conversão de tipos";
            ...
            } else if (stackTrace.includes("executeQueryLocal") || errorMessage.includes("executeQueryLocal")) {
                apiError = "executeQueryLocal";
            }
